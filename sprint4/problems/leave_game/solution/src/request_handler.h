...
public:
    ...
    RequestHandler(app::Application& application, extra_data::LootTypesData& extra_data,
                   postgres::Database& db, fs::path static_root, Strand api_strand)
       : static_root_{fs::weakly_canonical(static_root)}
       , api_strand_{api_strand}
       , api_handler_{std::make_shared<ApiHandler>(application, extra_data, db)} {
    }
